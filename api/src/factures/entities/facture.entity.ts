...
export interface Facture extends Document {
    ...
    Fac_Articles: [{ Fac_Operation: string, Fac_idArticle: Types.ObjectId, Fac_Amount: Number, Fac_Unit_Price: Number, Fac_cost: Number, Fac_Total_Product: Number, Fac_Total_cost: Number }];
    Fac_Total: { type: Number, require: true };
    Fac_Total_cost: { type: Number, require: true }
}